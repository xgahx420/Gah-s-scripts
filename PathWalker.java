...
public class PathWalker extends Script
   implements ActionListener, ItemListener {
    ...
    public static final Location[] locations = new Location[] {
        ...
        new Location("Barbarian Village", 233, 514, false),
        new Location("Catherby", 440, 496, true),
        new Location("Champions Guild", 150, 553, false),
        ...
        new Location("Yanille Watchmen", 637, 734, false),
        ...
        new Location("Trav Members Gate", 341, 488, false),
        new Location("Gnome Battlefield", 645, 666, false),
        new Location("Wildy Dark Wizards", 313, 415, false),
    ...
    private Node getCurrentDest() {
        ...
        do {
            ...
            if (!isReachable(next.x, next.y) && handleObstacles(x, y)) {
                ...
                wait_time = c_time + random(500, 800);
                path_ptr = ptr - 1;
                return null;
            }
